...
var apod = {
    ...
    //   var url = "https://api.nasa.gov/planetary/apod?api_key=bNLZbTtquM8ZZCDBd5pu0F3R6sNBP5egEqM5G7jm&date=" + date;
...
buildDOM: function(result) {
  ...
  getRequest: function() {
    ...
    let url = "https://api.nasa.gov/planetary/apod?api_key=bNLZbTtquM8ZZCDBd5pu0F3R6sNBP5egEqM5G7jm&date=" + date;
    $.ajax({
        url: url
